...
<template>
  ...
  <div class="md:grid md:grid-cols-4 md:gap-x-7 lg:gap-x-15 gap-y-6">
    <img class="mx-auto w-2/3 md:my-6 md:w-full" src="https://www.juanrloaiza.com/images/academic_loaiza.png" />
    ...
    <div class="md:flex md:gap-x-6 col-span-3 col-start-2 lg:justify-around">
      <div class="md:my-0 md:w-1/2 lg:w-1/3 lg:my-6" v-for="(areaType, key) in content?.areas">
