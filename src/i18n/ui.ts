...
export const ui = {
  en: {
    ...
    cvLink: "For a complete and updated version of my CV, click here.",
  ...
  es: {
    ...
    cvLink: "Para una versión completa y actualizada de mi CV, haga clic aquí.",
    ...
    otherDescription: "Proyectos fuera de mi investigación principal",
